...
describe RAAWS::Operation do
  before(:all) do
    @uri = "http://ecs.amazonaws.fr/onca/xml?AWSAccessKeyId=1GGP2X6SNBRNARDHET82&AssociateTag=charliechap0e-20&Author=Nabokov&Operation=ItemSearch&ResponseGroup=Small&SearchIndex=Books&Service=AWSECommerceService&Title=Ada&Version=2008-10-07"
